...
- Designed for Windows (may or may not work with Mac or Linux)
- Python 3.13
- Designed to run on Windows (untested on Mac or Linux).
...
### Usage
- If you want the program to run on a scheduled basis, you will need to use the
"Task Scheduler" that comes standard on Windows.
    - Launch the "Task Scheduler" by using the search bar.
